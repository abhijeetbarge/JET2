...
class CoreDataManager: NSObject {
    ...
    func getAllSavedArticalsFromCoreData() -> [Artical] {
        var articals  = [Artical]() // Where Locations = your NSManaged Class
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "Artical")
        articals = try! CoreDataManager.shared.persistentContainer.viewContext.fetch(fetchRequest) as! [Artical]
        return articals
    }
}
